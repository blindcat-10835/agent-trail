...
priority: p2
created: 2026-05-21
branch: fix/qoder-updated-time
worktree: .worktree/fix-qoder-updated-time
updated: 2026-05-22
---
...
- [x] Qoder session 的 updated_at 来源跟其他 source 一致
- [x] 列表按 updated_at 排序时 Qoder session 的位置合理
