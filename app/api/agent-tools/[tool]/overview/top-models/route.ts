/**
 * BFF API Proxy — GET /api/agent-tools/[tool]/overview/top-models
 *
 * Proxies top model ranking requests to the ingest service.
...
export async function GET(
  ...
  try {
    ...
    const data = await fetchIngest(
      `/api/v1/overview/top-models?${sourceParam}${qs}`,
